...
to pheromone-colour
  ...
  [ set pcolor scale-color green flood-filler 0 2;ifelse pheromone > sim-pheromone
...
to-report flood-fill
  ask patches [set flood-filler 0]
  ask patch 0 0 [set flood-filler 1000]
  set my-counter 0
  loop
  [ diffuse flood-filler 0.5
    ask patches [ if pcolor = yellow [set flood-filler 0]]
    set my-counter my-counter + 1
    if my-counter > 200
    [ report 0 ]
    if [flood-filler] of patch 30 30 > 0 or [flood-filler] of patch -30 -30 > 0
    [ report 1 ]
  ]
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot entrance"
...
<experiments>
  ...
  <experiment name="het-grote-experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>entrance / amount-of-flood-fills</metric>
    <enumeratedValueSet variable="template">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pherosim-amount">
      <value value="261"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pherotimer">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="density">
      <value value="10"/>
    ...
    <enumeratedValueSet variable="rock-stigmergy">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pheromone-stigmergy">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pheromone-sim-stigmergy">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="number">
      <value value="50"/>
    ...
    <enumeratedValueSet variable="template-radius">
      <value value="15"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="template-width">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pheromone-following">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="pheromone-drop-concentration">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ant-stigmergy">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
